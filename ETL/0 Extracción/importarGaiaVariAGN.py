...
def procesar_archivo(archivo):
    ...
    if archivo.endswith('.gz'):
        ...
        # Elimina las primeras 60 líneas de la lista
        del lines[0:60]
        ...
        # Leer el archivo descomprimido a partir de la línea 61
