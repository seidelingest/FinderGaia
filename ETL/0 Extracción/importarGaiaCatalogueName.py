...
db = client['TFM']
collection = db['Gaia DR3 CatalogueName']

print('Borrando datos de la colección')
collection.delete_many({})

# Directorio donde están los archivos .gz
directorio = 'E:\Catalogo\Gaia DR3\QsoCatalogueName'
...
def procesar_archivo(archivo):
    ...
    if archivo.endswith('.gz'):
        ...
        # Elimina las primeras 54 líneas de la lista
        del lines[0:54]
        ...
        # Leer el archivo descomprimido a partir de la línea 55
